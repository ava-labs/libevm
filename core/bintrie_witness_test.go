...
func TestProcessVerkle(t *testing.T) {
	var (
		...
		intrinsicContractCreationGas, _ = IntrinsicGas(code, nil, nil, true, &rules)
		...
		intrinsicCodeWithExtCodeCopyGas, _ = IntrinsicGas(codeWithExtCodeCopy, nil, nil, true, &rules)
