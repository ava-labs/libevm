...
func (s *hookedStateDB) GetCommittedState(addr common.Address, hash common.Hash, opts ...stateconf.StateDBStateOption) common.Hash {
	return s.inner.GetCommittedState(addr, hash, opts...)
}

func (s *hookedStateDB) GetState(addr common.Address, hash common.Hash, opts ...stateconf.StateDBStateOption) common.Hash {
	return s.inner.GetState(addr, hash, opts...)
}
...
func (s *hookedStateDB) SetState(address common.Address, key common.Hash, value common.Hash, opts ...stateconf.StateDBStateOption) common.Hash {
	prev := s.inner.SetState(address, key, value, opts...)
